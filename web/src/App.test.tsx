...
describe('App', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(api.getCapabilities).mockResolvedValue({ ai_enrichment_available: false, job_description_import_available: false, candidate_profile_import_available: false, persistence_available: false });
  });
